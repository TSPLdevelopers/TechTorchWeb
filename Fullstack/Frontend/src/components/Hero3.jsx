...
export default function Hero3() {
  ...
  if (activeView === "understand") {
    return (
      <section className="w-full bg-[#730042] min-h-[520px]">
        <div className="w-full px-4 sm:px-6 md:px-10 lg:px-20 py-8 sm:py-10 lg:py-12">
  ...
  return (
    <section className="w-full bg-[#730042] min-h-[520px]">
      <div className="w-full px-4 sm:px-6 md:px-10 lg:px-[100px] py-8 sm:py-10 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">

          {/* LEFT CONTENT */}
          
<div className="text-white lg:-translate-y-8">
            <h2
              className="
                mt-1
                text-[30px]
            ...
            <div className="mt-14 flex flex-wrap gap-5">
              <button
                ...
                className="
                  ...
                  hover:border-white
                  hover:-translate-y-1
                  hover:shadow-[0_6px_15px_rgba(115,0,66,0.4)]
                "
              >
                UNDERSTAND
              </button>
