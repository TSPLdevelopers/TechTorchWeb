  ...
  return (
    <section className="relative w-full min-h-[550px] overflow-hidden bg-[#f9f8f3]">
      ...
      <div
        ...
        style={{ width: "1200px", height: "850px", right: "-300px", top: "-80px", 
        backgroundImage: "url('/Section.png')", backgroundSize: "100% 150%", 
      ...
      sm:px-[30px] md:px-[40px] lg:flex-row lg:items-center lg:px-[100px]">
        ...
        <div className="relative z-20 w-full pt-[30px] sm:pt-[35px] md:w-[60%] md:pt-[40px] lg:w-[52%] lg:pt-[10px]">
          ...
          <div className="mt-[30px] sm:mt-[32px] md:mt-[35px] lg:mt-[20px] flex flex-wrap items-center">
            ...
            <button className="border border-[#8a0055] rounded-[4px] bg-transparent px-[9px] py-[7px]
             sm:px-[10px] sm:py-[8px] lg:px-[11px] lg:py-[9px] text-[17px] sm:text-[19px] lg:text-[20px] font-semibold font-plus-jakarta leading-none text-[#83004f] transition-all duration-300 hover:bg-[#83004f] hover:text-white">
              Learn More
            </button>
            ...
            <div className="ml-[25px] sm:ml-[40px] md:ml-[55px] lg:ml-[102px] mt-[16px] text-center">
              ...
              <h2 className="text-[20px] sm:text-[22px] md:text-[24px] lg:text-[28px] font-medium
               font-plus-jakarta leading-none text-black">
                Siddharth Pathak
              </h2>

              <p className="mt-[10px] text-[13px] sm:text-[14px] md:text-[15px] lg:text-[17px] 
              font-normal font-inter leading-[1.2] text-[#83004f]">
        ...
        {/* ================= IMAGE ================= */}
        <div className="relative z-20 mt-[30px] flex w-full justify-center md:absolute md:right-[20px]
         md:bottom-0 md:mt-0 md:w-auto md:justify-normal lg:right-[100px]">

          <img
            src="/img.png"
            alt="Siddharth Pathak"
            className="relative z-20 block h-auto w-[180px] sm:w-[210px] md:w-[250px] lg:w-[350px] 
            object-contain"
          />
