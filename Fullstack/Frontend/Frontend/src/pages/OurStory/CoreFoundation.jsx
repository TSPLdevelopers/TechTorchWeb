    ...
    <section className="w-full bg-[#F4F6FB] py-10 sm:py-14 md:py-16 lg:py-20 px-4 sm:px-8 lg:px-10 font-inter overflow-x-hidden">
      ...
      >
        ...
        <div className="w-full max-w-xl lg:max-w-none lg:self-start">
          ...
          <p
            className="
<<<<<<< HEAD:Fullstack/Frontend/src/pages/OurStory/CoreFoundation.jsx
              max-w-[420px]
              lg:max-w-[360px]
=======
              max-w-[360px] max-w-full
>>>>>>> 750724bebc99e4050a15d82bf3870b2cb99f9563:Fullstack/Frontend/Frontend/src/pages/OurStory/CoreFoundation.jsx
              text-[15px]
              sm:text-[16px]
              leading-relaxed
              text-black
